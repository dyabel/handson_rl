...
class ActorCritic(nn.Module):
    def __init__(self, obs_shape, action_space, device, shared_base=True, base=None, base_kwargs=None):
...
class CNNBase(NNBase):
    def __init__(self, num_inputs,shared=True, recurrent=False, hidden_size=512):
        ...
        self.main_act = deepcopy(self.main)
