...
class RLTrainer(object):
    def __init__(self,algo,args,device):
        ...
        self.algo = algo(actor_critic, args.clip_param, args.ppo_epoch, args. device)
...
def main():
    ...
    algo = PPO(actor_critic, args.clip_param, args.ppo_epoch, args.entropy_coef,
                        args.lr, args.eps, args.gamma, args.gae_lambda, args.num_mini_batch, 
                        args.use_clipped_value_loss,args.value_loss_coef,args.max_grad_norm,
                        device)
    trainer = RLTrainer(algo,args,device)
    trainer.train()
